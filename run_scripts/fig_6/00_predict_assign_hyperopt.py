...
for subdir in Path(res_folder).glob("*"):
    ...
    cmd_2 = f"python data_processing/forward/08_assign_formulae.py  --preds {save_name} --out {tree_out} --num-bins 15000 --upper-limit 1500 --orig-labels {orig_labels} --split-file {split_file}"
